                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" value="{{old('name')}}"  placeholder="Nhập tên sliders">
                                        </div>
                                        @include('admin.alert')
                                        <div class="form-group">
                                            <label>Url</label>
                                            <input type="text" name="url" class="form-control" value="{{old('url')}}"  placeholder="Nhập đường dẫn liên kết">
                                        </div>
                                        <div class="form-group">
                                            <label>Ưu tiên</label>
