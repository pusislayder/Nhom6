                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" class="form-control"  id="menu" value="<?php echo e($product->price); ?>" placeholder="Nhập giá sản phẩm">
                                        </div>
                                        <div class="form-group">
                                            <label>Giá khuyến mãi</label>
                                            <input type="number" name="price_sale"  class="form-control" id="menu" value="<?php echo e($product->price_sale); ?>" placeholder="Nhập giá khuyễn mãi">
                                        </div>
                                        <div class="form-group">
                                            <label>Số lượng</label>
                                            <input type="number" name="quantity"  class="form-control"  value="<?php echo e($product->quantity); ?>" placeholder="Nhập số lượng">
                                        </div>
                                        <div class="mb-3">
...
<?php
 ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dhmobile/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>