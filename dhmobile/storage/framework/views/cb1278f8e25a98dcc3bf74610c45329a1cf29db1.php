                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" value="<?php echo e($slider->name); ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>uu tien</label>
                                            <input type="number" name="sort_by" class="form-control" value="<?php echo e($slider->sort_by); ?>">
                                        </div>
                                        <div class="mb-3">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dhmobile/resources/views/admin/slider/edit.blade.php ENDPATH**/ ?>