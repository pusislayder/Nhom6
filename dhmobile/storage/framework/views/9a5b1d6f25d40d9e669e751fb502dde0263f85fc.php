<?php $__env->startSection('content'); ?>
    <div class="container p-t-80">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="/danh-muc/<?php echo e($product->menu->id); ?>-<?php echo e(Str::slug($product->menu->name)); ?>.html"
               class="stext-109 cl8 hov-cl1 trans-04">
                <?php echo e($product->menu->name); ?>
    ...
    <section class="sec-product-detail bg0 p-t-65 p-b-60">
                            ...
                            <div class="wrap-slick3-dots">
                                <ul class="slick3-dots" style="" role="tablist">
                                    <li class="slick-active" role="presentation">
                                        <img src="<?php echo e($product->thumb); ?>">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <span class="mtext-106 cl2">
							<?php echo \App\Helpers\Helper::price($product->price, $product->price_sale); ?>
                        ...
                        <h4 class="mtext-105 cl2 js-name-detail p-b-14">
                            Số lượng : <?php echo e($product->quantity); ?>
        ...
        <div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
            ...
            <span class="stext-107 cl6 p-lr-25">
				Categories: <?php echo e($product->menu->name); ?>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dhmobile/resources/views/products/content.blade.php ENDPATH**/ ?>