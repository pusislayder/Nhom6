                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>"  placeholder="Nhập tên sản phẩm">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" class="form-control"  id="menu" value="<?php echo e(old('price')); ?>" placeholder="Nhập giá sản phẩm">
                                        </div>
                                        <div class="form-group">
                                            <label>Giá khuyến mãi</label>
                                            <input type="number" name="price_sale"  class="form-control" id="menu" value="<?php echo e(old('price_sale')); ?>" placeholder="Nhập giá khuyễn mãi">
                                        </div>
                                        <div class="form-group">
                                            <label>Số lượng</label>
                                            <input type="number" name="quantity"  class="form-control"  value="<?php echo e(old('quantity')); ?>" placeholder="Nhập số lượng">
                                        </div>
                                        <div class="mb-3">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/dhmobile/resources/views/admin/product/add.blade.php ENDPATH**/ ?>