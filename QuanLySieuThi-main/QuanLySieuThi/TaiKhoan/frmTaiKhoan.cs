    ...
    public partial class frmTaiKhoan : Form
    {
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            }
            {
                try
                {               
                    string select = "select count(*) from taikhoan where username='N" + txt_tk.Text + "'";
                    string them1 = "insert into taikhoan Values ('" + uername + "','" + password + "',N'" + fullname + "','" + date + "','" + role + "')";
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Update taikhoan set password ='" + password + "', fullname=N'"+fullname + "', isAdmin='" + role +
