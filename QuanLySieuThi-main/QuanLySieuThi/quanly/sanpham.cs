...
{ 
    ...
    {
        public string chuoi = "select sanpham.masp , sanpham.tensp , " +
            "nhacungcap.tenncc , sanpham.gianhap , sanpham.giaban , " +
            "sanpham.solg , sanpham.hsd , sanpham.noisx , sanpham.donvitinh , " +
            "sanpham.nguoinhap " +
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql1 = "Insert into sanpham values(N'" + txt_tensp.Text + "',N'" + txt_mancc.SelectedValue + "','" + txt_gianhap.Text + "','" + txt_giaban.Text + "','" + txt_solg.Text + "','" + txt_hsd.Text.Trim() + "',N'" + txt_nsx.Text + "',N'" + txt_dvt.Text + "',N'" + txtNguoiNhap.Text + "')";
